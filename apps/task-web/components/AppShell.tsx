...
import { CheckSquare, LayoutDashboard, Plus, ChevronsUpDown, Check, Building2 } from "lucide-react";
    ...
    ? [
        {
          ...
          items: [
            ...
            { title: "New Task", href: `/org/${orgId}/workspace/${workspaceId}/tasks/new`, icon: Plus },
          ],
        },
      ]
    : [
